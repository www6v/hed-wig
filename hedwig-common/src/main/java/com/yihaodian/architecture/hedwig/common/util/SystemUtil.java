...
/**
 * Thanks for jcs team, they provide a way to bypass the jdk bug: <a
 * href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=4665037" >here</a>
 * which oracle and sun can't fix.
 * 
 * @author root
 * 
 */
	...
	private static InetAddress getLocalHostLANAddress() throws UnknownHostException {
		try {
			...
			for (Enumeration<NetworkInterface> ifaces = NetworkInterface.getNetworkInterfaces(); ifaces.hasMoreElements();) {
				...
				//if(iface.isUp()) { // bug fix in docker: status of network adaptor in docker is not up.
