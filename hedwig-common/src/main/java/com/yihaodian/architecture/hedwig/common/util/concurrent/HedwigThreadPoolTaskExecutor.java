 ...
 * {@link java.util.concurrent.ThreadPoolExecutor} in bean style (through its
 * "corePoolSize", "maxPoolSize", "keepAliveSeconds", "queueCapacity"
 * properties), exposing it as a Spring
 * {@link org.springframework.core.task.TaskExecutor}. This is an alternative to
 * configuring a ThreadPoolExecutor instance directly using constructor
 * injection, with a separate
 * {@link org.springframework.scheduling.concurrent.ConcurrentTaskExecutor}
 * adapter wrapping it.
 *
 * <p>
 * For any custom needs, in particular for defining a
 * {@link java.util.concurrent.ScheduledThreadPoolExecutor}, it is recommended
 * to use a straight definition of the Executor instance or a factory method
 * definition that points to the JDK 1.5 {@link java.util.concurrent.Executors}
 * class. To expose such a raw Executor as a Spring
 ...
 * JDK 1.5 {@link java.util.concurrent.Executor} interface, with the former
 * being the primary interface, the other just serving as secondary convenience.
 * For this reason, the exception handling follows the TaskExecutor contract
 * rather than the Executor contract, in particular regarding the
 ...
 */
class HedwigThreadPoolTaskExecutor extends CustomizableThreadFactory implements SchedulingTaskExecutor, Executor, BeanNameAware,
	...
	private RejectedExecutionHandler rejectedExecutionHandler = new HedwigThreadPoolExecutor.AbortPolicy();
	 ...
	 * inherits from). See
	 * {@link org.springframework.util.CustomizableThreadCreator}'s javadoc for
	...
	public void setRejectedExecutionHandler(RejectedExecutionHandler rejectedExecutionHandler) {
		this.rejectedExecutionHandler = (rejectedExecutionHandler != null ? rejectedExecutionHandler
				: new HedwigThreadPoolExecutor.AbortPolicy());
	}
	...
	public void initialize() {
		...
		this.threadPoolExecutor = new HedwigThreadPoolExecutor(this.corePoolSize, this.maxPoolSize, this.keepAliveSeconds,
