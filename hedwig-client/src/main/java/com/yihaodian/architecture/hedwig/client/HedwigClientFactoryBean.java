...
public class HedwigClientFactoryBean extends HedwigEventInterceptor implements FactoryBean {
	...
	public HedwigClientFactoryBean(Class<?> clazz, String domainName, String serviceAppName, String serviceName, String serviceVersion,
	...
	public HedwigClientFactoryBean(Class<?> clazz, String target, String serviceAppName, String clientAppName, Long timeout, String user,
	...
	public HedwigClientFactoryBean(Class<?> clazz, String target, String serviceAppName, String clientAppName, Long timeout)
			throws Exception {
		super();
		this.serviceInterface = clazz;
		setServiceAppName(serviceAppName);
